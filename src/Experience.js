...
<div className="container py-5" id="Experience">
 ...
 <h1 class="display-3 d-auto text-center">Experience</h1>
 </div>
 <div className="card-deck pt-3">

  <div className="card">
    <img className="card-img-top" src= {encore} alt="" />
  ...
  <div className="card">
    <img className="card-img-top" src={target} alt="" />
    <div className="card-body">
  ...
  <div className="card">
    <img className="card-img-top img-thumbnail" src={lyft} alt="" />
    <div className="card-body">
